                                    ...
                                    <table class="table table-striped table-bordered table-hover dataTable no-footer" id="dataTables-categories" aria-describedby="dataTables-categories-info">
                                        <thead>
                                            <tr role="row">
                                                ...
                                                <th class="sorting" tabindex="0" aria-controls="dataTables-categories" rowspan="1" colspan="1" style="width: auto;" aria-label="Platform(s): activate to sort column ascending">Create Date
                                                </th>
                                                <th class="sorting" tabindex="0" aria-controls="dataTables-categories" rowspan="1" colspan="1" style="width: auto;" aria-label="Browser: activate to sort column ascending">Orders
                                                </th>
                                                <th class="sorting" tabindex="0" aria-controls="dataTables-categories" rowspan="1" colspan="1" style="width: 12%;" aria-label="CSS grade: activate to sort column ascending" style="text-align: center;">Actions
                                                </th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                    ...
                                    <div class="modal-dialog modal-sm" style="width: 349px;">
                                      <div class="modal-content" style="width: 330px; height: 215px;">
                                        ...
                                        <div class="modal-footer">
                                          <button type="button" class="btn btn-danger" onclick="location.href='{{route('backend.categories.del', $category->id)}}'"><i class="icon-ok icon-white"></i> Yes</button>
